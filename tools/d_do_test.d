...
bool compareOutput(string output, string refoutput, const ref EnvData envData)
{
    ...
    version (LDC)
    if (refoutput.startsWith("// Automatically generated by Digital Mars D Compiler"))
        refoutput = "// Automatically generated by LDC Compiler" ~ refoutput[53 .. $];
...
int tryMain(string[] args)
{
    ...
    if (!testArgs.isDisabled && !collectExtraSources(input_dir, output_dir, testArgs.objcSources, testArgs.sources, envData, "clang", null, /*objC=*/true))
        return 1;
    ...
    Result testCombination(bool autoCompileImports, string argSet, size_t permuteIndex, string permutedArgs)
    {
        ...
        try
        {
            ...
            if (!testArgs.compileSeparately)
            {
                ...
                string of = testArgs.mode == TestMode.RUN || testArgs.link
                    ? test_app_dmd
                    /**
